...
import { BlockVariant } from './ArticleEditPage';
...
export const createArticle = async (
    ...
    try {
        ...
        const result = await $api.post('/articles', {
            ...
            type,
            blocks,
            createdAt: `${date.getDay() < 10 ? `0${date.getDay()}` : `${date.getDay()}`}.${date.getMonth() < 10 ? `0${date.getMonth()}` : `${date.getMonth()}`}.${date.getFullYear()}`,
            views: 0,
        })
